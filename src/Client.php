...
class Client
{
     ...
     *
     * @throws InvalidArgumentException (ripcord::notRipcordCall) when handling a multiCall and the
     *                                                                    arguments passed do not have the correct method call information
     * @throws RemoteException|ConfigurationException when _throwExceptions is true and the server returns an XML-RPC Fault.
     */
